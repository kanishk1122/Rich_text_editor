...
k instanceof v.YXmlEvent?({attributesChanged:k}=k,0<k.size&&p.syncPropertiesFromYjs(g,k)):A(82)}g=n.$getSelection();n.$isRangeSelection(g)&&(S(g)?(h=f._selection,n.$isRangeSelection(h)&&(ma(a,b),S(g)&&U(g.anchor.key,f)),pa(a,b,h,n.$getSelection())):ma(a,b))},{onUpdate:()=>{oa(a,b);e.update(()=>{0===n.$getRoot().getChildrenSize()&&n.$getRoot().append(n.$createParagraphNode())})},skipTransforms:!0,tag:d?"historic":"collaboration"})}
