...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/ks/.vscode/extensions/wallabyjs.console-ninja-1.0.366/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2008d6a470a482a436116eBRZdAk8EDQRXA1oEUAEFVAdVAQcJ', mode: 'build'}); } catch(cjsError) { try { import('file:///home/ks/.vscode/extensions/wallabyjs.console-ninja-1.0.366/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2008d6a470a482a436116eBRZdAk8EDQRXA1oEUAEFVAdVAQcJ', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
